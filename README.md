...
The quick-reference help message generated by the current RAiSD release is the following.
    ...
    This is RAiSD version 1.0, released in June 2017.
     ...
     -l	Provides the theshold score, reported by a previous run using a false positive rate (e.g., 0.05, via -k) to report the true positive rate.
...
The in-tool help generates a list of parameters, as shown above. Those in brackets are optional.
