...
RAiSD: A software tool for selective sweep detection
===============================================
...
An article describing the method and the software in detail is published here: https://www.nature.com/articles/s42003-018-0085-8
...
The quick-reference help message generated by the current RAiSD release is the following.
    ...
    This is RAiSD version 1.3, released in July 2018.
     ...
     -i     Imputes missing data per SNP (The default operation is to discard the SNP).
