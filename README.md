...
The quick-reference help message generated by the current RAiSD release is the following.
      ...
      DETAILED DESCRIPTION
		...
		matching outlier positions reported by RAiSD and SweeD. Based on the accuracy of the implemented methods in SweeD and RAiSD, we typically set -COD to a value between 100 and 400 sites (default: 1, i.e., exact match).
